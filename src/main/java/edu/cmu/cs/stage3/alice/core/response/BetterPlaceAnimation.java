...
public class BetterPlaceAnimation extends PointOfViewAnimation {
	...
	public class RuntimeBetterPlaceAnimation extends RuntimePointOfViewAnimation {
		...
		protected javax.vecmath.Vector3d getPositionEnd() {
			...
			edu.cmu.cs.stage3.alice.core.SpatialRelation sv = BetterPlaceAnimation.this.spatialRelation.getSpatialRelationValue();
			javax.vecmath.Vector3d v = sv.getPlaceVector( BetterPlaceAnimation.this.amount.doubleValue(), m_subjectBoundingBox, m_asSeenByBoundingBox );
			return v;
		}
